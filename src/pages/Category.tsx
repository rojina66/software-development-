    ...
    return (
        <div className={'category-container'}>
            <div className={'category-header'}>
                ...
                <div className={'category-btn_before'}>
                ...
                <div className={'category-search_button'}>
                    <button>
            ...
            <div className={'category-main-content'}>
                ...
                <div className={'category-product-list grid-view'}>
            ...
            <div className={'category-footer'}>
                <div className={'category-get-help'}>
                    <h1>GET HELP</h1>
                ...
                <div className={'category-about-us'}>
                    <h1>CaseIt</h1>
                    <Link to="/Aboutus">
                        <button>About Us</button>
                    </Link>
